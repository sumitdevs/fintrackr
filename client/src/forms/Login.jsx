...
const Login = ()=>{
    ...
    return(
        ...
        <div className='w-full mx-auto lg:w-1/3 md:w-1/2 flex flex-col justify-center items-center gap-6 p-10 bg-white rounded-md'>
            <h2 className='text-4xl font-semibold text-clr_primary_300'>Login</h2>
            <form onSubmit={handleSubmit} action="" className='w-full flex flex-col gap-4'>
                ...
                <button className='bg-clr_accent_200 hover:bg-clr_accent_100 py-2 rounded-sm text-white' type="submit">Login</button>
            ...
            <button className="relative w-full flex items-center hover:border-clr_accent_200 bg-white border px-6 py-2">
